...
BACKEND_DESCRIPTION="Forkop-Mod backend. Routing cores (sing-box, Xray) are optional Components, not package dependencies."
APP_DESCRIPTION="LuCI Forkop-Mod app. Routing cores (sing-box, Xray) are installed from Components."

...
const EXCLUDED_DNS_SERVER_TAG = "excluded-dns-server";
const EXCLUDED_DNS_HTTPS_TAG = "excluded-dns-https";
...
const XRAY_PLANE_MIXED_INBOUND_TAG = "xray-plane-mixed-in";
const XRAY_PLANE_MIXED_INBOUND_ADDRESS = "127.0.0.1";
const XRAY_PLANE_MIXED_INBOUND_PORT = 4536;
...
const RESERVED_TAGS = {
    ...
    [EXCLUDED_DNS_SERVER_TAG]: true,
    [EXCLUDED_DNS_HTTPS_TAG]: true,
    ...
    [XRAY_PLANE_MIXED_INBOUND_TAG]: true,
...
return {
    ...
    EXCLUDED_DNS_SERVER_TAG,
    EXCLUDED_DNS_HTTPS_TAG,
    FAKEIP_DNS_RULE_TAG,
    ...
    XRAY_PLANE_MIXED_INBOUND_TAG,
    XRAY_PLANE_MIXED_INBOUND_ADDRESS,
    XRAY_PLANE_MIXED_INBOUND_PORT,
